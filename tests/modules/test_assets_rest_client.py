...
class TestRestAssetRepository:
    """RestAssetRepository のテスト"""

    def test_rest_client_正常初期化(self) -> None:
        """REST APIクライアントが正常に初期化されることを確認"""
        config = AssetsConfig(
        ...
        client = RestAssetRepository(config)
        assert client._config == config

    def test_rest_client_id検索_正常レスポンス(self) -> None:
        ...
        mock_response_data = [
            {
                ...
                "host_name": "switch01.example.com",
    ...
    def test_rest_client_機種名検索_複数件レスポンス(self) -> None:
        ...
        mock_response_data = [
            ...
            },
            {
                "id": str(uuid4()),
                "model_name": "Cisco Catalyst 9300",
                "host_name": "switch02.example.com",
    ...
    def test_rest_client_検索結果0件(self) -> None:
        """検索結果が0件の場合の確認"""
        config = AssetsConfig()
    ...
    def test_rest_client_接続エラー_None返却(self) -> None:
    ...
    def test_rest_client_404エラー_None返却(self) -> None:
        """404エラー時にNoneが返却されることを確認"""
        config = AssetsConfig()
    ...
    def test_rest_client_500エラー_リトライ後None返却(self) -> None:
    ...
    def test_rest_client_無効なjsonレスポンス_None返却(self) -> None:
    ...
    def test_rest_client_Bearer認証ヘッダー設定(self) -> None:
    ...
    def test_rest_client_複合検索条件_クエリパラメータ設定(self) -> None:
        """複合検索条件が正しくクエリパラメータに設定されることを確認"""
        config = AssetsConfig()
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            assert params.get("model_name") == "Cisco Catalyst 9300"
            assert params.get("location") == "Tokyo-DataCenter-Rack01"
